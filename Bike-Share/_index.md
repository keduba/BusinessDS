...
This is an exercise on bike-shares to explore the factors that influence the use. That way the business could implement some resource control or allocation.
